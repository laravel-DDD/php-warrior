...
class Detonate extends Base
{
    ...
    public function perform(string $direction = 'forward')
    {
    ...
    public function bomb($direction, $xAxis, $yAxis, $damage_amount)
    {
        if ($this->unit->position) {
            $receiver = $this->space($direction, $xAxis, $yAxis)->unit();
